        ...
        <div class="col-md-12 column">
            <form action="fldAction" method="post" id="frm">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="flda" name="flda" value="${param.flda}"
                           placeholder="整形主键">
                </div>
                <div class="form-group">
                    <label for="fldb">FLDB</label>
                    <input type="text" class="form-control" id="fldb" name="fldb" value="${param.flda}"
                           placeholder="字符串">
                </div>
                <div class="form-group">
                    <label for="fldc">FLDC</label>
                    <input type="text" class="form-control" id="fldc" name="fldc" value="${param.flda}"
                           placeholder="浮点格式">
                </div>
                <div class="form-group">
