    ...
    <div class="col-md-12 column">
      <form action="fldAction" method="post">
        ...
        <div class="form-group">
          ...
          <button type="button" class="btn btn-default" onclick="window.location.href='index.jsp'">insert</button>
          <button type="button" class="btn btn-default" style="float: right"  onclick="window.location.href='memAction'">logout</button>
        </div>
      </form>
    </div>
  </div>
