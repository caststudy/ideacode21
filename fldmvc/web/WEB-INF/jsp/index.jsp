            ...
            function () {
              ...
              $("#flda").keyup(function(){
                ...
                if(s[0]){
                  ...
                  $.ajax({
                    type:"post",
                    url:"${pageContext.servletContext.contextPath}/fldAction/check",
                    data:{flda:flda,test:"#$@"},
...
<div class="container">
  <div class="row clearfix">
    <div class="col-md-12 column">
      <form action="${pageContext.servletContext.contextPath}/fldAction/insert" method="post"  id="frm">
